...
== UI Design
  1. Sign Up
    1. Kikuchiyos Way Logo In Header
    2. Link to Log In Page
    3. Sign Up Header
    4. Form Container ( Blue to Black Gradiant with Rounded Corners )
      1. Username Label => Username Input      
      2. Password Label => Password Input
      3. Password Confirmation Label => Password Confirmation Input
  2. Log In
    1. Kikuchiyos Way Logo In Header
